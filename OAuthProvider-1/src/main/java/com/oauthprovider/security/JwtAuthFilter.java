...
import com.oauthprovider.exception.ResourseNotFoundException;
...
//	    			e.printStackTrace();
			...
			logger.info("Invlid Header value!!");
	            ...
	            if (useremail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
	                User user = userRepository.findByEmail(useremail).orElseThrow(()-> new  ResourseNotFoundException("Invalid Token"));
